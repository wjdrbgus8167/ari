...
public class AlbumLikeJpaEntity {
     ...
     */
    public static AlbumLikeJpaEntity fromDomain(AlbumLike albumLike) {
        return AlbumLikeJpaEntity.builder()
                .albumLikeId(albumLike.getAlbumLikeId())
                .albumId(albumLike.getAlbumId())
